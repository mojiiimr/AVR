...
#define __alcd_useBL  true // Control Backlight (true/false)

#define __alcd_RS_Config   DDRH
#define __alcd_RS_Control  PORTH
#define __alcd_RS_Pin      5

#define __alcd_EN_Config   DDRH
#define __alcd_EN_Control  PORTH
#define __alcd_EN_Pin      6

#define __alcd_DB4_Config  DDRG
#define __alcd_DB4_Control PORTG
#define __alcd_DB4_Pin     5

#define __alcd_DB5_Config  DDRE
#define __alcd_DB5_Control PORTE
#define __alcd_DB5_Pin     3

#define __alcd_DB6_Config  DDRH
#define __alcd_DB6_Control PORTH
#define __alcd_DB6_Pin     3

#define __alcd_DB7_Config  DDRH
#define __alcd_DB7_Control PORTH
#define __alcd_DB7_Pin     4

#ifdef __alcd_useBL // Backlight Control
    #define __alcd_BL_Config   DDRB
    #define __alcd_BL_Control  PORTB
    #define __alcd_BL_Pin      4
#endif
